...
def train():
    ...
    model.save_replay_buffer('TQC-PandaPickAndPlace-v3-buffer')
...
def test():
    ...
    model = TQCEnvSwitchWrapper.load('TQC-PandaPickAndPlace-v3',env=train_env)
    # model.env = train_env
...
def retrain():
    ...
    model = TQCEnvSwitchWrapper.load('TQC-PandaPickAndPlace-v3',env=test_env)
    model.eval_env = True
